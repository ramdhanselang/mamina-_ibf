            ...
            public void onResponse(Call<ResponseKonselor> call, Response<ResponseKonselor> response) {
                ...
                if (response.isSuccessful()){
                    ...
                    if (status){
                        ...
                        KonselorListAdapter adapter = new KonselorListAdapter(ListKonselorActivity.this, data_dokter);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(ListKonselorActivity.this, "Tidak ada berita untuk saat ini", Toast.LENGTH_SHORT).show();
                    }
                }
            }
